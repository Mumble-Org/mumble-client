  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.type_container}>
        <div
          onClick={setProducer}
          className={`${styles.type_box} ${type === 'producer' ?
            styles.type_box_active : styles.type_box_inactive}`}
        >
          <Image
            src={type === 'producer' ? '/checked_box.svg' : '/unchecked_box.svg'}
        ...
        <div
          onClick={setArtist}
          className={`${styles.type_box} ${type === 'artist' ?
            styles.type_box_active : styles.type_box_inactive}`}
        >
          <Image
        ...
        <div
          onClick={setEngineer}
          className={`${styles.type_box} ${type === 'engineer' ?
            styles.type_box_active : styles.type_box_inactive}`}
        >
        <Image
            src={type === 'engineer' ? '/checked_box.svg' : '/unchecked_box.svg'}
